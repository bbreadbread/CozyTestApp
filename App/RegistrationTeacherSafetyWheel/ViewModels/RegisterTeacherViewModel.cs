...
namespace RegistrationCuratorCozyTest.ViewModels
{
    public class RegisterCuratorViewModel : INotifyPropertyChanged
    {
        ...
        private void Register()
        {
            ...
            var partid =  _participantService.GetLast();
            ...
            MessageBox.Show("Экзаменатор зарегистрирован");
            ClearFields();
            Load();
        }
        ...
        public void Remove()
        {
            if (originalCurator != null)
            {
                ...
                {
                    _curatorService.Remove(originalCurator);
                    ClearFields();
                }
            }
            Load();
        ...
        public void Update()
        {
            ...
            if (originalCurator != null)
            {
                ...
                _curatorService.Update( _selectedCurator );
            }
        ...
        {
            Items.Clear();
            foreach (var p in _curatorService.Curators)
                Items.Add(p);
        }
