...
public partial class CozyTestContext : DbContext
{
    ...
    public CozyTestContext(DbContextOptions<CozyTestContext> options) : base(options)
    {
    }
    ...
    public virtual DbSet<ParticipantsFavoriteTest> ParticipantsFavoriteTests { get; set; }
    ...
    public virtual DbSet<Сorrespondence> Correspondences { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_Criteria");
            entity.Property(e => e.Id).HasColumnName("ID");
            ...
            entity.HasOne(c => c.Test)
                .WithMany(t => t.Criteria)
                .HasForeignKey(c => c.TestId)
                .HasConstraintName("FK_Criteria_Tests");
        });
        ...
        modelBuilder.Entity<ParticipantAnswer>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.AttemptId, e.QuestionId, e.ConstantOptionId });

            entity.Property(e => e.AttemptId).HasColumnName("Attempt_ID");
            entity.Property(e => e.QuestionId).HasColumnName("Question_ID");
            entity.Property(e => e.OptionId).HasColumnName("Option_ID");
            entity.Property(e => e.ConstantOptionId).HasColumnName("ConstantOption_ID");
        ...
        modelBuilder.Entity<Сorrespondence>(entity =>
        {
            entity.HasKey(e => new { e.ConstantId, e.СorrespondingId });

            entity.ToTable("Correspondences");

            entity.Property(e => e.ConstantId).HasColumnName("Constant_ID");
            entity.Property(e => e.СorrespondingId).HasColumnName("Сorresponding_ID");

            entity.HasOne(c => c.Constant)
                .WithMany(o => o.Сorrespondences)
                .HasForeignKey(c => c.ConstantId)
                .OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(c => c.Corresponding)
                .WithMany()
                .HasForeignKey(c => c.СorrespondingId)
                .OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ParticipantsAssignedTest>(entity =>
        {
            ...
            entity.HasOne(d => d.Curator).WithMany(p => p.ParticipantsAssignedTests)
                .HasForeignKey(d => d.ResponsibleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Participants_Assigned_Tests_Curators");
        });
        ...
        modelBuilder.Entity<ParticipantsFavoriteTest>(entity =>
        {
            ...
            entity.HasOne(d => d.Participant).WithMany(p => p.ParticipantsFavoriteTests)
                .HasForeignKey(d => d.ParticipantId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Participants_Favorite_Tests_Participants");

            entity.HasOne(d => d.Test).WithMany(p => p.ParticipantsFavoriteTests)
                .HasForeignKey(d => d.TestId)
                .OnDelete(DeleteBehavior.ClientSetNull)
